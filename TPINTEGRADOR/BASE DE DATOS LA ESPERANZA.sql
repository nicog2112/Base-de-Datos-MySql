#BASE DE DATOS LA ESPERANZA
create database la_esperanza;
use la_esperanza;

#CENTROS - Contiene información de los centros que forman el colegio la ESPERANZA.
...
#CURSOS - Contiene información de los cursos que se imparten en cada centro. Un centro puede tener varios cursos.
CREATE TABLE CURSOS(
...
#ALUMNOS - Contiene la información de los alumnos de todo el colegio, y el curso en el que está.
...
TLF VARCHAR(10),
NOTA_MEDIA float(3,1));

#DEPARTAMENTOS – Los distintos departamentos que forman el colegio.
CREATE TABLE DEPARTAMENTOS(
COD_DEPAR INT(4) PRIMARY KEY,
NOMBRE_DEPAR VARCHAR(20),
NUM_ASIG INT(3));

#ASIGNATURAS – Las asignaturas de cada curso y que son impartidas por los departamentos. Una asignatura sólo pertenece a un departamento y un curso.
...
#EVALUACIONES – Contiene la información de las notas de cada alumno en las asignaturas en la que está matriculado y por evaluación.
